...
// #define TCFG_DEBUG_PORT                     IO_PORT_DP
// #define TCFG_DEBUG_PORT                     IO_PORTC_06  // 原配置，与屏幕引脚冲突
#define TCFG_DEBUG_PORT                     IO_PORTB_03    // 改用 PB3
...
#define TCFG_SD_DET_IO                      -1//IO_PORTA_01	//SD_DET_MODE为SD_IO_DECT时有效
#define TCFG_SD_DET_IO_LEVEL                0			//IO检卡上线的电平(0/1),SD_DET_MODE为SD_IO_DECT时有效
#define TCFG_SD_CLK                         20000000	//SDIO时钟
